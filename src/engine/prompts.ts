...
5. HONEST ASSESSMENT — one paragraph explaining your reasoning. Be honest. A candidate who gets false confidence wastes their time.
6. PILE POSITION — emit \`pilePosition\` as one of "top", "middle", or "bottom": if this CV landed on a recruiter's desk alongside 50 others for this role, where would it likely sit? This is a structured field, not prose — every response MUST include it.
